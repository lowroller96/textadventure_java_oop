...
public class StoryGenerator extends Story {
    ...
    public Story[] getStories() {
        ...
        stories[2]= new Story("Ein freundlicher Händler schenkt dir ein paar Münzen.",0,+20,false,"Marktplatz");
    ...
    public StoryGenerator(String erzaehlElement, int auswirkungGesundheit, int auswirkungKonto, boolean isteventNegativ,String ort) {
        super(erzaehlElement, auswirkungGesundheit, auswirkungKonto, isteventNegativ,);
    }

    public void storyGenerieren(Story) {
